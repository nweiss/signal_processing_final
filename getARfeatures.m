...
% for our project:use syntax like:featureVec = getARfeatures(data, 1); 
% or featureVec = getARfeatures(data, 2);
% where data(a*b*c) has a:selected channels, b:selected time pointe,
% c:selected trials
