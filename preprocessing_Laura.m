...
% info given in the problem (in ms)
fs = 1000; 
t_bef = 200;
...
if SAVE_DATA
    params.t_bef = t_bef;
    params.fs = fs;
    params.low_cut_off = low_cut_off;
    params.hi_cut_off = hi_cut_off;
    parampath = fullfile('data', ['data_v' num2str(PROCESSED_DATA_VERSION)],'params.mat');
    save(parampath,'params');
end
